...
se'n conserven l'HTML i el text extret.

| Fitxer | Contingut |
| --- | --- |
| `assemblea-general-2020-pressupost.html` / `.txt` | Comunicació de l'Assemblea General de 2020; informa d'un pressupost de prop de **6 milions d'euros** per al 2020. |

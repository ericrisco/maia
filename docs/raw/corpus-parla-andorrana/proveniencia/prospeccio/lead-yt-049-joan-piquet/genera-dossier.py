"""Prepara el dossier de prospecció de Joan Piquet fora del cànon."""
...
SMALL=json.loads((ASR/'joan-piquet-small-nocontext.json').read_text())
BASE=json.loads((ASR/'joan-piquet-base-nocontext.json').read_text())
FORMS_SOURCE=Path(__file__).parents[2]/'candidats/lead-rtva-008-mireia-pedescoll/formes-consens.tsv'
EXTRA=[('reiki', 'salut'), ('Reiky', 'salut'), ('energia', 'salut'), ('meditació', 'salut'), ('teràpia', 'salut'), ('teràpies', 'salut'), ('cursos', 'educació'), ('mestre', 'professió'), ('cos', 'salut'), ('emocions', 'societat'), ('consciència', 'societat'), ('Andorra', 'toponim'), ('andorrà', 'gentilici'), ('família', 'societat'), ('alumnes', 'educació'), ('formació', 'educació'), ('benestar', 'salut')]
...
def main():
    ...
    for idx,(form,cat) in enumerate(forms,1):
        ...
        if seg:
            ...
            clip=f'lead-yt-049__{idx:02d}__{slug}.wav'; out=CLIPS/clip
            if not out.exists():
        ...
        if clip: queue.append({'candidate':'lead-yt-049-joan-piquet','forma':form,'clip':f'clips/{clip}','veu_confirmada':'pendent','forma_confirmada':'pendent','variant_transcrita':'pendent','trets_fonetica':'pendent','prosodia':'pendent','nota_audicio':'pendent','estat_audicio':'pendent'})

"""Prepara el dossier de prospecció de Albert Vilaró fora del cànon."""
...
SMALL=json.loads((ASR/'albert-vilaro-small-nocontext.json').read_text())
BASE=json.loads((ASR/'albert-vilaro-base-nocontext.json').read_text())
FORMS_SOURCE=Path(__file__).parents[2]/'candidats/lead-rtva-008-mireia-pedescoll/formes-consens.tsv'
EXTRA=[('diners', 'economia'), ('finances', 'economia'), ('economia', 'economia'), ('mercat', 'economia'), ('banca', 'economia'), ('inversió', 'economia'), ('empresa', 'economia'), ('emprenedoria', 'economia'), ('pressupost', 'economia'), ('inversions', 'economia'), ('fiscal', 'economia'), ('govern', 'institucions'), ('ministre', 'institucions'), ('política', 'institucions'), ('turisme', 'societat'), ('habitatge', 'societat'), ('comerç', 'societat'), ('treball', 'societat'), ('Andorra', 'toponim'), ('andorrà', 'gentilici'), ('futur', 'societat')]
...
def main():
    ...
    for idx,(form,cat) in enumerate(forms,1):
        ...
        if seg:
            ...
            clip=f'lead-yt-051-albert-vilaro__{idx:02d}__{slug}.wav'; out=CLIPS/clip
            if not out.exists():
        ...
        if clip: queue.append({'candidate':'lead-yt-051-albert-vilaro-albert-vilaro','forma':form,'clip':f'clips/{clip}','veu_confirmada':'pendent','forma_confirmada':'pendent','variant_transcrita':'pendent','trets_fonetica':'pendent','prosodia':'pendent','nota_audicio':'pendent','estat_audicio':'pendent'})

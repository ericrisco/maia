"""Prepara el dossier de prospecció de Valentí Closa fora del cànon."""
...
SMALL=json.loads((ASR/'valenti-closa-small-nocontext.json').read_text())
BASE=json.loads((ASR/'valenti-closa-base-nocontext.json').read_text())
FORMS_SOURCE=Path(__file__).parents[2]/'candidats/lead-rtva-008-mireia-pedescoll/formes-consens.tsv'
EXTRA=[('conseller', 'institucions'), ('cultura', 'societat'), ('aparcaments', 'societat'), ('Escaldes-Engordany', 'toponim'), ('Escaldes', 'toponim'), ('comú', 'institucions'), ('parròquia', 'institucions'), ('mobilitat', 'societat'), ('equipaments', 'societat'), ('serveis', 'societat'), ('Andorra', 'toponim'), ('andorrà', 'gentilici'), ('turisme', 'societat'), ('pressupost', 'economia'), ('joves', 'societat'), ('música', 'societat'), ('festival', 'societat')]
...
def main():
    ...
    for idx,(form,cat) in enumerate(forms,1):
        ...
        if seg:
            ...
            clip=f'lead-yt-052-valenti-closa__{idx:02d}__{slug}.wav'; out=CLIPS/clip
            if not out.exists():
        ...
        if clip: queue.append({'candidate':'lead-yt-052-valenti-closa-valenti-closa','forma':form,'clip':f'clips/{clip}','veu_confirmada':'pendent','forma_confirmada':'pendent','variant_transcrita':'pendent','trets_fonetica':'pendent','prosodia':'pendent','nota_audicio':'pendent','estat_audicio':'pendent'})

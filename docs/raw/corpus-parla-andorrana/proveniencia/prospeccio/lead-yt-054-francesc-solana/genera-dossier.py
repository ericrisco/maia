"""Prepara el dossier de prospecció de Francesc Solana fora del cànon."""
...
SMALL=json.loads((ASR/'francesc-solana-small-nocontext.json').read_text())
BASE=json.loads((ASR/'francesc-solana-base-nocontext.json').read_text())
FORMS_SOURCE=Path(__file__).parents[2]/'candidats/lead-rtva-008-mireia-pedescoll/formes-consens.tsv'
EXTRA=[('bàsquet', 'esport'), ('esport', 'esport'), ('equip', 'esport'), ('jugadors', 'esport'), ('partit', 'esport'), ('victòria', 'esport'), ('lliga', 'esport'), ('play-off', 'esport'), ('Andorra', 'toponim'), ('andorrà', 'gentilici'), ('joves', 'societat'), ('formació', 'societat'), ('Palència', 'toponim'), ('Burgos', 'toponim'), ('turisme', 'societat'), ('treball', 'societat'), ('família', 'societat')]
...
def main():
    ...
    for idx,(form,cat) in enumerate(forms,1):
        ...
        if seg:
            ...
            clip=f'lead-yt-047__{idx:02d}__{slug}.wav'; out=CLIPS/clip
            if not out.exists():
        ...
        if clip: queue.append({'candidate':'lead-yt-054-francesc-solana','forma':form,'clip':f'clips/{clip}','veu_confirmada':'pendent','forma_confirmada':'pendent','variant_transcrita':'pendent','trets_fonetica':'pendent','prosodia':'pendent','nota_audicio':'pendent','estat_audicio':'pendent'})

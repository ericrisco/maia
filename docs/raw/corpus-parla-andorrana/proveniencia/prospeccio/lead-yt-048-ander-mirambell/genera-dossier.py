"""Prepara el dossier de prospecció de Ander Mirambell fora del cànon."""
...
SMALL=json.loads((ASR/'ander-mirambell-small-nocontext.json').read_text())
BASE=json.loads((ASR/'ander-mirambell-base-nocontext.json').read_text())
FORMS_SOURCE=Path(__file__).parents[2]/'candidats/lead-rtva-008-mireia-pedescoll/formes-consens.tsv'
EXTRA=[('esport', 'esport'), ('esports', 'esport'), ('esportista', 'esport'), ('Skeleton', 'esport'), ('atleta', 'esport'), ('Jocs Olímpics', 'esport'), ('Jocs Paralímpics', 'esport'), ('medalla', 'esport'), ('competició', 'esport'), ('entrenament', 'esport'), ('Andorra', 'toponim'), ('andorrà', 'gentilici'), ('Barcelona', 'toponim'), ('família', 'societat'), ('fundació', 'societat'), ('joves', 'societat'), ('neu', 'medi ambient'), ('muntanya', 'territori')]
...
def main():
    ...
    for idx,(form,cat) in enumerate(forms,1):
        ...
        if seg:
            ...
            clip=f'lead-yt-048__{idx:02d}__{slug}.wav'; out=CLIPS/clip
            if not out.exists():
        ...
        if clip: queue.append({'candidate':'lead-yt-048-ander-mirambell','forma':form,'clip':f'clips/{clip}','veu_confirmada':'pendent','forma_confirmada':'pendent','variant_transcrita':'pendent','trets_fonetica':'pendent','prosodia':'pendent','nota_audicio':'pendent','estat_audicio':'pendent'})

"""Prepara el dossier de prospecció de Oriol Agorreta fora del cànon."""
...
SMALL=json.loads((ASR/'oriol-agorreta-small-nocontext.json').read_text())
BASE=json.loads((ASR/'oriol-agorreta-base-nocontext.json').read_text())
FORMS_SOURCE=Path(__file__).parents[2]/'candidats/lead-rtva-008-mireia-pedescoll/formes-consens.tsv'
EXTRA=[('joier', 'professió'), ('òpera', 'cultura'), ('òperes', 'cultura'), ('contes', 'cultura'), ('escriure', 'cultura'), ('escriptor', 'cultura'), ('música', 'cultura'), ('teatre', 'cultura'), ('art', 'cultura'), ('joies', 'economia'), ('or', 'economia'), ('plata', 'economia'), ('Andorra', 'toponim'), ('andorrà', 'gentilici'), ('La Massana', 'toponim'), ('literatura', 'cultura'), ('escenari', 'cultura'), ('personatge', 'cultura'), ('novel·la', 'cultura'), ('creativitat', 'cultura')]
...
def main():
    ...
    for idx,(form,cat) in enumerate(forms,1):
        ...
        if seg:
            ...
            clip=f'lead-yt-043__{idx:02d}__{slug}.wav'; out=CLIPS/clip
            if not out.exists():
        ...
        if clip: queue.append({'candidate':'lead-yt-043-oriol-agorreta','forma':form,'clip':f'clips/{clip}','veu_confirmada':'pendent','forma_confirmada':'pendent','variant_transcrita':'pendent','trets_fonetica':'pendent','prosodia':'pendent','nota_audicio':'pendent','estat_audicio':'pendent'})

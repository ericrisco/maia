"""Prepara el dossier de prospecció de Ricard Fiter fora del cànon."""
...
SMALL=json.loads((ASR/'ricard-fiter-small-nocontext.json').read_text())
BASE=json.loads((ASR/'ricard-fiter-base-nocontext.json').read_text())
FORMS_SOURCE=Path(__file__).parents[2]/'candidats/lead-rtva-008-mireia-pedescoll/formes-consens.tsv'
EXTRA=[
 ('advocat','professió'),('dret','institucions'),('drets humans','institucions'),('drets i llibertats','institucions'),
 ('Lliga Andorrana dels Drets de l’Home','institucions'),('Lliga Andorrana','institucions'),('Raonador del Ciutadà','institucions'),
 ('ciutadà','institucions'),('administració','institucions'),('funcionari','institucions'),('ministeri','institucions'),
 ('secretari general','institucions'),('Consell General','institucions'),('conseller general','institucions'),
 ('ambaixador','institucions'),('Consell d’Europa','institucions'),('Croàcia','toponim'),('Eslovènia','toponim'),
 ('Sant Julià','toponim'),('Andorra','toponim'),('andorrà','gentilici'),('andorrans','gentilici'),
 ('immigració','societat'),('emigració','societat'),('refugiat','societat'),('refugiats','societat'),
 ('guerra civil','història'),('drets dels infants','societat'),('drets de les dones','societat'),
 ('nacionalitat','institucions'),('administratiu','dret'),('expedient','administració'),('llibertat','institucions'),
 ('català','sociolingüística'),('francès','contacte'),('castellà','contacte'),('poble','territori'),
 ('parròquia','institucions'),('Constitució','institucions'),('memòria','cultura'),('llegenda','cultura'),
]
...
def main():
    ...
    for idx,(form,cat) in enumerate(forms,1):
        ...
        if seg:
            ...
            clip=f'lead-rtva-018__{idx:02d}__{slug}.wav'; out=CLIPS/clip
            if not out.exists():
        ...
        if clip: queue.append({'candidate':'lead-rtva-018-ricard-fiter','forma':form,'clip':f'clips/{clip}','veu_confirmada':'pendent','forma_confirmada':'pendent','variant_transcrita':'pendent','trets_fonetica':'pendent','prosodia':'pendent','nota_audicio':'pendent','estat_audicio':'pendent'})

"""Prepara el dossier de prospecció de Laura Casanovas fora del cànon."""
...
SMALL=json.loads((ASR/'laura-casanovas-small-nocontext.json').read_text())
BASE=json.loads((ASR/'laura-casanovas-base-nocontext.json').read_text())
FORMS_SOURCE=Path(__file__).parents[2]/'candidats/lead-rtva-008-mireia-pedescoll/formes-consens.tsv'
EXTRA=[('escriptora', 'professió'), ('escriure', 'cultura'), ('escriptura', 'cultura'), ('contes', 'cultura'), ('novel·la', 'cultura'), ('llibres', 'cultura'), ('lectura', 'educació'), ('literatura', 'cultura'), ('premi', 'cultura'), ('premis', 'cultura'), ('personatges', 'cultura'), ('argument', 'cultura'), ('Andorra', 'toponim'), ('andorrà', 'gentilici'), ('Pirineus', 'toponim'), ('editorial', 'cultura'), ('infants', 'societat'), ('joves', 'societat'), ('família', 'societat'), ('català', 'sociolingüística')]
...
def main():
    ...
    for idx,(form,cat) in enumerate(forms,1):
        ...
        if seg:
            ...
            clip=f'lead-yt-044__{idx:02d}__{slug}.wav'; out=CLIPS/clip
            if not out.exists():
        ...
        if clip: queue.append({'candidate':'lead-yt-044-laura-casanovas','forma':form,'clip':f'clips/{clip}','veu_confirmada':'pendent','forma_confirmada':'pendent','variant_transcrita':'pendent','trets_fonetica':'pendent','prosodia':'pendent','nota_audicio':'pendent','estat_audicio':'pendent'})

"""Prepara el dossier de prospecció de Alberto Villagrasa fora del cànon."""
...
SMALL=json.loads((ASR/'alberto-villagrasa-small-nocontext.json').read_text())
BASE=json.loads((ASR/'alberto-villagrasa-base-nocontext.json').read_text())
FORMS_SOURCE=Path(__file__).parents[2]/'candidats/lead-rtva-008-mireia-pedescoll/formes-consens.tsv'
EXTRA=[('ciberseguretat', 'tecnologia'), ('seguretat', 'tecnologia'), ('internet', 'tecnologia'), ('xarxes', 'tecnologia'), ('dades', 'tecnologia'), ('privacitat', 'tecnologia'), ('tecnologia', 'tecnologia'), ('informació', 'tecnologia'), ('policia', 'institucions'), ('estafa', 'societat'), ('fraus', 'societat'), ('Andorra', 'toponim'), ('andorrà', 'gentilici'), ('joves', 'societat'), ('educació', 'educació'), ('família', 'societat'), ('mòbil', 'tecnologia')]
...
def main():
    ...
    for idx,(form,cat) in enumerate(forms,1):
        ...
        if seg:
            ...
            clip=f'lead-yt-046__{idx:02d}__{slug}.wav'; out=CLIPS/clip
            if not out.exists():
        ...
        if clip: queue.append({'candidate':'lead-yt-046-alberto-villagrasa','forma':form,'clip':f'clips/{clip}','veu_confirmada':'pendent','forma_confirmada':'pendent','variant_transcrita':'pendent','trets_fonetica':'pendent','prosodia':'pendent','nota_audicio':'pendent','estat_audicio':'pendent'})

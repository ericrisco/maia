"""Resumeix i prepara l'audició del candidat RTVA DJ Neura."""
...
SMALL = CAND / "asr" / "dj-neura.json"
BASE = CAND / "asr" / "dj-neura-base.json"
...
""", encoding="utf-8")
    ...
    for row in chosen:
        ...
        filename = f"dj-neura__{slug(str(row['forma']))}__{float(row['inici_s']):.2f}.wav"

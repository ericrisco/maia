"""Resumeix i prepara l'audició del candidat Consell General Xavier Espot."""
...
SMALL = CAND / "asr" / "xavier-espot.json"
BASE = CAND / "asr" / "xavier-espot-base.json"
...
""", encoding="utf-8")
    ...
    for row in chosen:
        ...
        filename = f"xavier-espot__{slug(str(row['forma']))}__{float(row['inici_s']):.2f}.wav"

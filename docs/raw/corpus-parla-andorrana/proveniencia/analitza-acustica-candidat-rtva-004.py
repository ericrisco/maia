"""Calcula descriptors acústics orientatius per als clips de Joan Micó."""
from __future__ import annotations
import csv, wave
from pathlib import Path
import numpy as np
ROOT=Path(__file__).parents[1]; CAND=ROOT/'proveniencia'/'candidats'/'lead-rtva-004-joan-mico'; RATE=16000; FRAME=640; HOP=320; FFT=2048; THRESH=10**(-35/20)
...
def main():
 ...
 lines=['# Perfil acústic — Joan Micó','','Les mesures són descriptors instrumentals dels clips seleccionats. No substitueixen l’escolta ni permeten atribuir una variant dialectal.','', '| forma | durada | F0 mediana | F0 IQR | veu | pausa mediana |','|---|---:|---:|---:|---:|---:|']

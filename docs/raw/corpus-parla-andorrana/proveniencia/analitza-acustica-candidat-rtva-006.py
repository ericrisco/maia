"""Calcula descriptors acústics orientatius per als clips de Jaume Tomàs."""
from __future__ import annotations
import csv, wave
from pathlib import Path
import numpy as np
ROOT=Path(__file__).parents[1]; CAND=ROOT/'proveniencia'/'candidats'/'lead-rtva-006-jaume-tomas'; RATE=16000; FRAME=640; HOP=320; FFT=2048; THRESH=10**(-35/20)
...
def main():
 ...
 lines=['# Perfil acústic — Jaume Tomàs','','Les mesures són descriptors instrumentals dels clips seleccionats. No substitueixen l’escolta ni permeten atribuir una variant dialectal.','', '| forma | durada | F0 mediana | F0 IQR | veu | pausa mediana |','|---|---:|---:|---:|---:|---:|']
 ...
 report=CAND/'informe.md'; s=report.read_text(encoding='utf-8'); marker='## Revisió preparada\n'; block='## Perfil acústic instrumental\n\n`analisi-acustica.tsv` i `analisi-acustica.md` conserven durada, proporció de veu, F0, energia, centroid espectral i pauses dels 14 clips. Són descriptors exploratoris; no substitueixen l’audició ni confirmen trets dialectals.\n\n';

"""Resumeix i prepara l'audició del candidat Consell General Roser Suñé."""
...
SMALL = CAND / "asr" / "roser-sune-full.json"
BASE = CAND / "asr" / "roser-sune-full-base.json"
...
""", encoding="utf-8")
    ...
    for row in chosen:
        ...
        filename = f"roser-sune__{slug(str(row['forma']))}__{float(row['inici_s']):.2f}.wav"

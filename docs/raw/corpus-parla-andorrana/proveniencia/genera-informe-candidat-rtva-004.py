"""Resumeix i prepara l'audició del candidat RTVA Joan Micó."""
...
SMALL = CAND / "asr" / "joan-mico.json"
BASE = CAND / "asr" / "joan-mico-base.json"
...
""", encoding="utf-8")
    ...
    for row in chosen:
        ...
        filename = f"joan-mico__{slug(str(row['forma']))}__{float(row['inici_s']):.2f}.wav"

...
OUT = PROV / "auditoria-incerteses.html"
...
def main() -> None:
    rows = read("cua-audicio-incerteses.tsv")
    priorities = {
    ...
    title = "Audició — mostra d'incerteses ASR del corpus independent"
...
<p class="muted">100 clips amb tokens ASR incerts, ordenats per probabilitat i categoria. Les anotacions es guarden al navegador.
...
const items={payload};const key='maia-corpus-audicio-incerteses-v1';

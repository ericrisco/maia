...
description: "L'última execució andorrana és del 18 d'octubre del 1943. El garrot el va comprar un copríncep perquè el considerava més humà que la forca."
tema: temes/institucions/justicia
veu: compilada
epoca: contemporania
apte_llengua: false
font: wikipedia-pena-de-mort-andorra
timestamp: 2026-09-13T23:55:00Z
tags: [institucions, justicia, historia]
---
...
**La pena de mort és prohibida per la Constitució de 1993.**

**L'última execució andorrana és del 18 d'octubre del 1943.**

> **Pere Areny Aleix, de vint-i-nou anys i de Canillo, va ser afusellat per haver
> assassinat el seu germà, Antoni Areny Baró.**

**El corpus tenia registrat que «no s'havia abolit la pena de mort» com un dels
cinc motius pels quals Andorra no encaixava a l'Europa del final del segle XX**
([la Transició Nacional](../../historia/historia-recent/la-transicio-nacional.md)).
**No en tenia ni un cas.**

## Com es va fer

| Què |
| --- |
| **Va estar empresonat al calabós del soterrani de la [Casa de la Vall](../patrimoni-institucional/casa-de-la-vall.md) durant gairebé tres mesos** |
| **La sentència es va executar dos dies després del judici** |
| **Seguint els costums del [Manual Digest](../../historia/manual-digest/manual-digest.md), la sentència es va llegir a la plaça pública**, en presència del condemnat i d'una multitud |
| **Se'l va conduir fins a la Roureda de Moles** |
| **El va afusellar un escamot del Cos de Policia** |

> **«Qualsevol persona podia demanar clemència i que la pena fos commutada per
> presó perpètua, però no en va demanar ningú.»**

**El corpus reté aquesta frase sencera.** **Descriu un procediment on l'indult
depenia que algú del públic el demanés, i ningú no el va demanar.**

## El que la recerca posterior ha trobat

> **«Investigacions recents han revelat que Areny no tingué un judici just i que
> probablement patia esquizofrènia.»**

**La font no diu quines investigacions ni de quan.** **Buit prioritari.**

**El corpus ho escriu igualment i amb èmfasi**: **l'última persona executada a
Andorra probablement estava malalta i probablement no va tenir un judici just.**

## Les altres dues

| Quan | Qui | Què |
| --- | --- | --- |
| **1860** | **Joan Mandicó** | **Acusat d'assassinar a ganivetades un veí seu.** **Executat a garrot vil** |
| **1896** | *(la font no en dona el nom)* | **Sentència dictada i commutada per presó perpètua** |
| **18 d'octubre del 1943** | **Pere Areny Aleix** | **Afusellat** |

## El garrot

> **«El mètode d'execució previst, el garrot vil, només s'aplicà una vegada, el
...
perquè el mateix bisbe Caixal surt, a la mateixa setmana de recerca, com el que
va impulsar la fundació de l'Institut de la Sagrada Família d'Urgell**, que
dirigeix dos dels tres col·legis confessionals del país
([les religions d'Andorra avui](../../costums/religiositat/les-religions-dandorra-avui.md)).

**I el corpus subratlla el que això vol dir sobre el mètode**: **si el garrot es
va comprar per al 1860 i només es va fer servir aquell cop, el 1943 es va
afusellar perquè s'havia deixat de banda l'instrument previst.** **La font no ho
explica.** **Buit.**

## Dues fonts del corpus, dos garrots que no encaixen

`Divergència registrada, no arbitrada:` **trobada el 2026-09-13 aparellant
aquesta fitxa amb [la presó sense llei](./la-preso-sense-llei.md).**

| Font | Què diu del garrot |
| --- | --- |
| **Viquipèdia**, aquesta fitxa | **«Només s'aplicà una vegada, el 1860»**, a Joan Mandicó. El va fer comprar el **copríncep Josep Caixal** perquè el considerava **més humà que la forca** |
| **Pere Canturri**, via [la presó sense llei](./la-preso-sense-llei.md) | **«A mitjan segle XIX se sol·licità permís al Copríncep episcopal per adquirir un garrot»** — i **«no tinc constància que hagi servit algun cop»** |

**Coincideixen en tot menys en el que importa**: qui el va autoritzar (el
copríncep episcopal, que a mitjan segle XIX és Caixal), quan (mitjan segle XIX) i
per què. **Discrepen en si es va fer servir.**

**El corpus no arbitra.** **Registra que la font de Canturri és memòria personal
declarada com a tal**, i que **la Viquipèdia no hi posa nota a peu.** **Què ho
...
- ~~**Quantes penes de mort s'han dictat a Andorra**, en total.~~ — **`parcial`, i
  ...
  **commutada per treballs forçats a França**, publicada en dibuix per
...
- ~~**Si el garrot es conserva.**~~ — **`resolt`**, i per un document que el
  ...
  Catalunya.»** **El que segueix obert és quina exposició**, i **on és el permís
  del copríncep** — **buit que aquella fitxa ja registrava pel seu compte.**
- ~~**El calabós del soterrani de la Casa de la Vall**: el corpus el té a
  [la presó sense llei](./la-preso-sense-llei.md) i **no sabia que hi hagués
  estat l'últim executat del país.**~~ — **`resolt`, i la resposta era al
  material en brut d'aquesta mateixa fitxa.**

  > **«Pere Areny fou empresonat al calabós del soterrani de la Casa de la Vall
  > durant gairebé tres mesos, i s'executà la sentència dos dies després del
  > judici. Seguint els costums del Manual Digest, la sentència es llegí a la
  > plaça pública, en presència del condemnat i d'una multitud, i a continuació
  > es conduí el reu fins a la Roureda de Moles, on va ser afusellat per un
  > escamot.»**
  > — [`Pena_de_mort_a_Andorra-ca.wiki`](../../../raw/web/referendums/Pena_de_mort_a_Andorra-ca.wiki)

  **Sí que hi va ser: gairebé tres mesos.** **I dos dies entre el judici i
  l'execució.** **I la lectura pública de la sentència seguia els costums del
  [Manual Digest](../../historia/manual-digest/manual-digest.md)** — cosa que
  lliga aquest episodi del **1943** amb
  [«Mort, qui t'ha mort?»](./mort-qui-tha-mort.md) i amb **les dues imatges
  separades per seixanta anys** que [la presó sense
  llei](./la-preso-sense-llei.md) compara: **un dibuix de *L'Illustration* del
  final del XIX i una fotografia del 1942 de la mateixa escena.**

  **I el lloc ja estava descrit.** Aquella fitxa el dona per memòria de Canturri, que el va veure de
  petit des del pati —«**el corral, que en dèiem**»—, **amb argolles per als
  canells**, i situa a la mateixa casa **la Cúria**, «on administraven justícia

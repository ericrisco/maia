---
type: article
title: El van demanar per estalviar, no per pietat
description: "El corpus tenia, des d'una enciclopèdia, que un copríncep va comprar el garrot perquè el considerava més humà que la forca. Una súplica del Consell General al Bisbe del 23 de novembre de 1854 diu una altra cosa: que penjar sortia car i que el demanaven per esperit d'economia. Amb la disputa del dret de gràcia que es va resoldre perquè el condemnat es va morir a la presó."
...
tags: [justicia, dret-penal, pena-de-mort, dret-de-gracia, coprincipat, consell-general, franca, segle-xix, font-primaria, prioritari]
---

# El van demanar per estalviar, no per pietat

## La unitat llegida

**«La peine de mort»** i **«Le droit de grâce et d'amnistie»**, **pàgines
326-327** del capítol IX de *La Coutume d'Andorre*, de **J.-A. Brutails** (1904),
amb les notes ([font](../../../fonts/brutails-coutume-1904.md)).

> **Per què aquesta fitxa existeix.** **El corpus té
> [la pena de mort](./la-pena-de-mort.md) escrita des d'una enciclopèdia**, i la
> regla de treball diu que **una branca escrita des d'una font secundària no és
> feta: s'ha de refer contra la font primària.** **Això és el que fa aquesta
> unitat**, **i el resultat contradiu la font secundària en el punt principal.**

## El motiu no era la pietat

**El que el corpus tenia, d'enciclopèdia:**

> «**El garrot el féu comprar el copríncep **Josep Caixal** perquè el considerà
> **més humà que la forca**.**»
> ([la pena de mort](./la-pena-de-mort.md))

**El que diu la font de 1904:**

> **Els condemnats a mort **antigament eren penjats**. **El senyor Pallerola ha
> tingut l'amabilitat d'assenyalar-me **una súplica del Consell General al Bisbe,
> de data 23 de novembre de 1854**, **exposant que **la penjada era costosa** i
> demanant, **per esperit d'economia**, **que fos substituïda pel garrot***.**

> **Tres diferències, i cap és de matís.**
>
> | | Enciclopèdia | **Brutails, 1904** |
> |---|---|---|
...
>
> **El corpus no diu que l'enciclopèdia s'equivoqui.** **Diu que **té dues
> versions incompatibles del motiu i de la iniciativa**, i que **la de 1904 ve
> d'un document datat que un veguer episcopal en exercici va assenyalar a
> l'autor**, mentre que **la de l'enciclopèdia no cita cap document.**
>
> **`Registrat i no arbitrat`, amb la diferència de rang documental feta
> constar.** **I amb una cautela que va en contra de la font nova**: **Brutails
> tampoc no transcriu la súplica**; **diu que l'hi van assenyalar.** **És, altra
> vegada, un document que el llibre coneix per indicació d'un tercer**, que és el
> defecte recurrent d'aquesta obra
> ([*cesan los demes tribunals inferiors*](./cesan-los-demes-tribunals-inferiors.md)).

> **`Lectura del corpus`, marcada com a seva.** **Les dues versions no són
> igualment plausibles com a motiu institucional.** **Un canvi de mètode
> d'execució demanat **pel parlament del país** i fundat en el cost encaixa amb
> tot el que el corpus ha documentat aquestes tandes**: **una justícia sense
> presó, sense personal, on la guarda d'un detingut era tan cara que es deixaven
> escapar els presoners**
> ([es deixaven escapar els presos](./es-deixaven-escapar-els-presos.md)) **i on el
> veguer de França havia de posar diners seus per tenir les Corts**
> ([el veguer de França pagava les Corts de la seva butxaca](./el-veguer-de-franca-pagava-les-corts-de-la-seva-butxaca.md)).
> **En aquell sistema, que una execució es decidís per preu no és estrany.**
> **Això és raonament del corpus i no prova res.**

## El cerimonial, i on es guardava l'instrument

> **El cerimonial de les execucions capitals **està minuciosament reglat pel
> *Politar****: **encadenament del condemnat, al coll un collar de ferro, a les
> mans unes *esposes*, assistència d'una confraria, port d'un crucifix, cant de
> salms, toc de la campana**. **«*Aquest protocol macabre no omet res del que pot
> fer el quadre lúgubre i l'expiació exemplar*.»**

> **Els condemnats són, doncs, **escanyats al garrot, com a Espanya***;
> **l'instrument del suplici **es guarda, si no recordo malament, en un cofre del
> menjador del Consell General***; **però amb prou feines serveix**, i **es pot
> dir, amb certs andorrans, que **la pena de mort és virtualment abolida** a les
> Valls.**
>
> **«*No es deixa d'ensenyar als estrangers, **a la riba de la Valira**, el lloc
> de les execucions*.»**
...
> malament»**— **que el corpus conserva.**
>
> **La segona és la formulació de la vigència**: ***virtualment abolida***, i
> **no de boca de l'autor sinó «*amb certs andorrans*».** **El corpus registra
> que el 1904 la pena de mort era, a Andorra, **una norma vigent que ja no
> s'aplicava**, i que qui ho deia eren els andorrans mateixos.**
>
> **La tercera és el turisme**: **el lloc de les execucions, a la riba de la
> Valira, **s'ensenyava als estrangers**.** **El corpus ho reté com a dada de
> memòria col·lectiva i no en dedueix la ubicació.**

> **I una convergència amb el que el corpus ja té.** **El collar de ferro i les
> *esposes* del cerimonial són **la mateixa ferramenta** que la font descriu als
> calabossos andorrans** —**«un luxe de cadenes terrificant: *ceps*, manilles o
> *esposes*, collar»**—
> ([es deixaven escapar els presos](./es-deixaven-escapar-els-presos.md)).
> **El país que no tenia presó tenia cadenes per a tot.**

## El bisbe va indultar, i li van dir que no podia

> **El 1854, **el Bisbe havia indultat un condemnat a mort**; **se li va negar
> aquest dret**, i **es va encetar una discussió interminable**, **en el curs de
> la qual **la dificultat va ser resolta per la mort del condemnat, que es va
> morir a la presó****.

> **El corpus reté la frase tal com és, perquè la manera de dir-ho és part del
> fet**: **la qüestió de si el copríncep episcopal pot indultar es va resoldre
> **perquè l'home es va morir esperant**.**
>
> **`Càlcul del corpus`, i és una inferència mínima**: **si va morir a la presó
> durant la disputa, **l'indult no es va aplicar i l'execució tampoc***.
> **Ningú no va guanyar la discussió.**

**I el Consell General va prendre posició, amb una fórmula que val la pena:**

> **Deliberació del **2 de gener de 1855***: «*A fi de que **ninguna autoritat no
> s'prenguia ninguna jurisdicio ni dret dels uns als altres**.*»

> **La fórmula no diu «el Bisbe no pot indultar».** **Diu que **cap autoritat no
> prengui jurisdicció ni dret dels altres**.** **És simètrica, i el corpus reté la
> simetria**: **el Consell General es posa com a guardià de l'equilibri entre els
> dos coprínceps i no com a part contra un.**
>
> **És exactament la mateixa tècnica que el corpus li ha vist el 1886 amb les
> presons** —**convertir el problema en un equilibri de privilegis que s'han de
> mantenir tots dos**—
> ([tornar la fama, el diumenge en sortir de missa](./tornar-la-fama-el-diumenge-en-sortir-de-missa.md)).
> **`Lectura del corpus`, marcada com a seva**: **és una constant de
> comportament, no una coincidència.**

**I la pretensió es va repetir:**

> **El 1882, **el Bisbe va amnistiar condemnats que complien la pena a França***;
> **se li va respondre que **l'acte era nul** i **es van guardar els presoners
> sota els panys**.**

> **El corpus registra el desenllaç sense atenuar-lo**: **una amnistia d'un
> copríncep **declarada nul·la i no executada**.**
>
> **I reté la circumstància que la fa possible**: **els condemnats eren **a
> França**.** **Qui tenia les claus no era Andorra.** **Això lliga amb la unitat
> anterior**: **des que els presoners van deixar d'anar a Espanya, l'amnistia
> episcopal va topar amb una administració que no depenia del Bisbe.**

**I l'autor hi posa una cautela que el corpus reté perquè és de mètode:**

> **«**És possible que el cosenyor eclesiàstic estigui en situació de citar
> precedents: **el Govern francès, massa llunyà per seguir els afers andorrans, ha
> pogut deixar als prelats la cura d'exercir el dret de gràcia i molts d'altres**.
> **Aquests fets no impliquen de cap manera per part seva l'abandonament de les
> seves prerrogatives.**»**

> **`Tesi de l'autor, registrada com a seva`, i el corpus la marca com el que
> és**: **un jurista francès explicant per què la pràctica episcopal no crea
> dret.** **El corpus no l'adopta** i **fa constar que l'argument és reversible**:
> **si la llunyania explica la pràctica, també explicaria per què els precedents
> episcopals són nombrosos.**
>
> **I anota que **la font no diu quins són aquells precedents**: parla en
> condicional d'uns precedents que el Bisbe «estaria en situació de citar».**

**I una tercera pretensió, d'un tercer actor:**

> **Certs veguers **han reivindicat el dret de gràcia***: **potser l'havien rebut
> per una delegació expressa**; **no entra dins les atribucions normals del seu
> càrrec.**

> **El corpus ho registra com a **tercera capa del mateix conflicte**: no és
> només Bisbe contra Consell General, **també hi ha veguers reclamant indultar
> pel seu compte**.** **La font ho descarta com a atribució ordinària i deixa
> oberta la delegació.** `Cap cas citat.`

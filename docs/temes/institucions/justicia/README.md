...
- [Arcaica més que antiga](./arcaica-mes-que-antiga.md) — La conclusió de Brutails diu que el costum andorrà deu menys a l'edat mitjana del que sembla i que usos d'aire vellíssim, com el retracte perpetu, són innovacions gairebé recents.
...
- [Els mateixos tretze dies, dues explicacions](./els-mateixos-tretze-dies-dues-explicacions.md) — Brutails diu deu dies de dret més tres de gràcia; Vilar diu deu dies que arriben a tretze perquè s'han de descomptar els feriats. Amb la justícia civil en forma de diamant i l'any per recuperar el que t'han executat.
...
- [No és bo que el jutge es pagui de les despulles](./no-es-bo-que-el-jutge-es-pagui-de-les-despulles.md) — La formulació final de la tesi de Brutails: que qui jutja cobri del condemnat i tingui interès, per petit que sigui, a declarar-lo culpable.
...
- [Va afegir a la sentència coses que ningú no havia demanat](./va-afegir-a-la-sentencia-coses-que-ningu-no-havia-demanat.md) — Les tres úniques sentències del Tribunal Superior d'Andorra que el corpus té, del 1902 i el 1903, amb la fórmula d'execució que acaba en els capitans de parròquia.

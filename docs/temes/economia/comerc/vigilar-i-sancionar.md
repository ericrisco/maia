...
- ~~**Quantes empreses de seguretat privada hi ha inscrites**~~ — **`parcial` el
  ...
  **5-6-2024** i una modificació del **26-2-2025**— **però no el registre
  d'empreses**: la cadena «Registre d'Empreses de Seguretat» **no surt a cap
  document del Butlletí**. **La via del BOPA queda descartada, no pendent.**
  `Requereix el ministeri d'Interior o una petició directa.`

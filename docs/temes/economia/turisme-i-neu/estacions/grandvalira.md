...
type: article
title: "Grandvalira"
description: "El domini esquiable més gran dels Pirineus, 215 km. Va començar el 1956 amb un telesquí de 450 esquiadors l'hora."
...
tags: [economia, turisme, esports, territori]
---
...
## Com va començar: un home i un telesquí

| Quan | Què |
| --- | --- |
| **1956** | **Francesc Viladomat instal·la el primer telesquí** al peu del **Coll Blanc**. **Podia transportar 450 esquiadors l'hora** |
...
| **Hivern del 2003** | **Es crea la marca Grandvalira** |
| 2007 | Pas de la Casa - Grau Roig celebra **cinquanta anys** |
...
**La temporada 2008-2009, a Grau Roig, s'hi va construir un hotel de gel.**
**Era el primer del sud d'Europa.**

| | |
| --- | --- |
| **On** | **2.300 metres d'altitud** |
| **Mida** | **600 m², nou habitacions, 34 persones** |
| **Temperatura interior** | **entre 1 i 3 graus positius** |
| **Lavabos** | **químics** — no hi havia aigua corrent |
| **Begudes** | **només transparents**, per no tacar la neu |
| **Menjar** | limitat, **amb la fondue com a especialitat** |
| **Llits** | amb **aïllament** i **sacs de dormir d'un sol ús** |

**I el detall que el corpus reté sobre tots els altres:**

> **Les estances es feien expressament de nou metres d'altura, perquè a mesura
> que anaven passant els mesos la distància amb el sostre s'anava reduint.**

**L'edifici s'enfonsava sobre si mateix durant la temporada, i estava dissenyat
per fer-ho.**

**Es refeia cada hivern.** **L'últim registre és de la temporada 2015-16**; **el
2018-19 ja no s'oferia.** **Avui l'experiència es fa amb cabanes i domos d'Epic
Andorra.**

## El que hi ha, avui

- **Sis accessos diferents a pistes** al llarg de la **CG-2**, la carretera de
  França, seguint el **Valira d'Orient**.
- **Grau Roig és l'únic sector amb circuit d'esquí de fons**,
  i **l'única estació del país on es pot fer fons i descens**.
- **Mon(t) Magic Family Park**, al sector de Canillo: **més de 100 hectàrees**,
  **la pista temàtica infantil més llarga del sud d'Europa** (2015), **la
  tirolina més gran d'Andorra** —**550 m de llargada, 40 d'alçada, uns 80 km/h**—
  i el **Màgic Gliss**, un tobogan de **555 metres** (2019).

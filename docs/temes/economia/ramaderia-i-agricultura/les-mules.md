...
type: article
title: Les mules
description: "El principal producte d'exportació d'Andorra després del ferro — incloent-hi mules franceses reexportades a Catalunya «com originàries d'Andorra»."
...
tags: [economia, ramaderia, comerc, traginers, fires]
---
...
> «Aquestes han estat **de sempre el principal producte d'exportació d'Andorra**
> (a banda del ferro).»
>
> — **David Mas** ([font](../../../fonts/mas-pagesos-i-artesans.md))

**El producte estrella d'Andorra no era el formatge, ni la llana, ni el vi. Era
la mula.**

És de les dades que més refan la imatge del país: no un lloc que es venia a si
mateix com a pintoresc, sinó **un proveïdor de mitjans de transport per a mig
Pirineu i la plana catalana**.

## Per què valien tant

Perquè **eren el principal mitjà de transport**, tant **al camp** com **als
camins**, on les menaven **els traginers**.

Abans del tractor i del camió, **una mula era un vehicle**. Vendre mules és
l'equivalent d'exportar maquinària.

## On es venien

A **les fires catalanes**. I el guany «era **una de les principals fonts
d'ingressos**», **tant per als pagesos grans com per als mitjans** — és a dir,
**no era negoci només de pairalia**: també hi arribava el propietari mitjà.

Això les separa de l'oví, que era cosa de grans
([la crisi de l'oví](./la-crisi-de-lovi.md)), i explica per què la mula guanya
terreny: **més accessible i, segons la frase de l'època que recull Mas, «major
benefici amb menys esforç»**.

## El detall incòmode: la reexportació

Mas no ho amaga, i el corpus tampoc:

> El comerç «esdevenia especialment lucratiu quan es tractava d'animals que
> **primerament eren importats de França i després es reexportaven a Catalunya
> com originaris d'Andorra**».

**Mules franceses venudes com a andorranes.**

No és una anècdota: és **el mateix mecanisme econòmic que el
[contraban](../../historia/contraban/contraban.md) i que el
[tabac](../tabac/tabac.md)** — Andorra explotant la seva posició entre dues
duanes i dos preus. Aquí el que travessa no és mercaderia amagada sinó
**origen**: el valor afegit és **el segell «d'Andorra»**.

Val la pena dir-ho sense moralina, perquè és estructural: **la funció econòmica
històrica d'Andorra ha estat, molt sovint, ser el lloc on una cosa canvia
d'estatus legal en travessar-lo.** Tabac, mules, i molt més tard
[banca](../banca-i-fiscalitat/banca-i-fiscalitat.md).

## Com s'acaba

**La mecanització.** Tractors, ferrocarrils i automòbils «les van deixar fora de
lloc».

I el final del recorregut, que Mas deixa anar en una línia i és duríssim:

> «En l'actualitat els equins que es crien a Andorra, **a diferència dels seus
> antecessors, tenen com a destí l'escorxador**.»
...
- [La crisi de l'oví](./la-crisi-de-lovi.md) — el bestiar que van substituir.
- [El contraban](../../historia/contraban/contraban.md) — el mateix mecanisme.

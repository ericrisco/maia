---
type: article
title: Cinquanta anys d'esquí olímpic
description: "Les catorze delegacions andorranes als Jocs d'hivern, nom per nom i cursa per cursa. Trenta-quatre anys en què Andorra només hi va portar esquiadors alpins, i el dia que va renunciar a una plaça."
tema: temes/esports/esqui
veu: compilada
epoca: contemporania
apte_llengua: false
font: wikipedia-jocs-andorra
timestamp: 2026-09-12T12:30:00Z
tags: [esports, esqui, jocs-olimpics, biatlo, surf-de-neu, competicio]
---

# Cinquanta anys d'esquí olímpic

## El buit que això tanca

[La fitxa dels Jocs Olímpics](../competicio/andorra-als-jocs-olimpics.md)
tenia les xifres de cada delegació d'hivern i **els noms només del 1976, 1988,
2010, 2018, 2022 i 2026**. **Faltaven set edicions senceres.** Aquí hi són
([font](../../../fonts/wikipedia-jocs-andorra.md)).

## El fet estructural

**Del 1976 al 2006 —trenta anys, nou edicions— Andorra va als Jocs d'hivern
només amb esquiadors alpins.** Cap altra disciplina.

**El primer que no és esquí alpí arriba el 2006**, i és **esquí de fons**.
**El segon és el 2010**, i és **surf de neu**. **El tercer és el 2014**, i és
**biatló**.
...
| Qui | Prova | Resultat |
| --- | --- | --- |
| **[Albert Llovera](../../persones/albert-llovera.md)** | Descens | **1:57.88 — 48è** |
| | Gegant i eslàlom | no acaba cap |
| **Jordi Torres** | Descens | **1:59.06 — 50è** |
| | Gegant i eslàlom | no acaba cap |

**Llovera hi va amb 17 anys. L'any següent, a la mateixa ciutat, un accident
de Copa d'Europa el deixa paraplègic**, i **torna a competir en ral·lis del
Campionat del Món**. Vegeu [la seva fitxa](../../persones/albert-llovera.md).

### Calgary 1988 — dos i dues

| Qui | Prova | Resultat |
| --- | --- | --- |
| **Nahum Orobitg** | Súper-G | **1:53.22 — 38è** |
| **Gerard Escoda** | Súper-G | no acaba |
...
| Qui | Prova | Resultat |
| --- | --- | --- |
| **Gerard Escoda** | Gegant **2:18.69 — 36è** · **eslàlom 1:54.71 — 32è** · súper-G desqualificat |
| **Nahum Orobitg** | Gegant **2:19.30 — 38è** · eslàlom no acaba · súper-G desqualificat |
| **Ramon Rossell** | **Súper-G 1:19.10 — 47è** · gegant i eslàlom no acaba |
| **Victor Gómez** | Gegant no acaba · súper-G desqualificat |
| **Vicky Grau** | **Súper-G 1:30.07 — 37a** · gegant i eslàlom no acaba |

**Tres súper-G desqualificats el mateix dia.** El corpus ho registra com a fet i
**no en sap el motiu**.

### Lillehammer 1994 — quatre i dues

| Qui | Prova | Resultat |
| --- | --- | --- |
| **Victor Gómez** | **Súper-G 1:38.64 — 43è** (+6.11) |
| **Gerard Escoda** | **Súper-G 1:38.77 — 44è** (+6.24). **17è a la primera mànega de l'eslàlom**; no acaba. Combinada: 25è a la primera mànega; no acaba |
| **Ramon Rossell** | **Súper-G 1:40.25 — 46è** |
| **Santi López** | Súper-G, no acaba |
| **Vicky Grau** | **Súper-G 1:26.39 — 36a** (+4.24). Gegant: **32a a la primera mànega**; no acaba |
| **Caroline Poussier** | **Eslàlom 2:06.82 — 24a** (+10.81). Gegant, no acaba |

**Gerard Escoda és 17è del món a mig eslàlom**, i no acaba. **És el millor
parcial que el corpus té documentat de l'esquí alpí andorrà d'aquells anys**, i
va quedar en no res.

### Nagano 1998 — dos i una

| Qui | Prova | Resultat |
| --- | --- | --- |
| **Vicky Grau** | **Eslàlom 1:37.69 — 19a**. Gegant, no acaba |
| **Victor Gómez** | Súper-G, gegant i eslàlom: **no acaba cap** |
| **Gerard Escoda** | Gegant i eslàlom: no acaba cap |

**El 19è lloc de Vicky Grau a Nagano és, de tot aquest període, el millor
resultat olímpic andorrà a la neu.**

### Salt Lake City 2002 — dos i una

**La setena participació consecutiva d'Andorra als Jocs d'hivern.**

| Qui | Prova | Resultat |
| --- | --- | --- |
| **Vicky Grau** | **Eslàlom 1:55.16 — 24a** de 38 que acaben. Gegant, no acaba la segona mànega |
| **Alex Antor** | **Gegant 2:31.39 — 36è** de 57. Eslàlom, no acaba la segona |
| **Victor Gómez** | **Gegant 2:33.33 — 39è** |

**Gómez i Grau hi arriben amb tres Jocs a l'esquena** —Albertville, Lillehammer
i Nagano— i **Antor hi debuta amb 22 anys**.

**El millor resultat d'Andorra a Salt Lake City és el 24è lloc de Grau.**

### Torí 2006 — dos alpins i el primer fondista

| Qui | Prova | Resultat |
| --- | --- | --- |
| **Roger Vidosa** | **Eslàlom 1:54.03 — 27è**. **Combinada 3:21.37 — 28è**. Descens **1:59.24 — 50è** |
| **Alex Antor** | **Descens 1:55.01 — 39è**. Súper-G, eslàlom i combinada: no acaba |
| **François Soulié** | **15 km clàssic: 44:42.6 — 71è** de 96. 30 km persecució i 50 km lliure: no acaba |
...
| Esport | Qui | Resultat |
| --- | --- | --- |
| **Esquí alpí** | **Mireia Gutiérrez** | **Combinada 2:42.30 — 18a**, amb un **15è lloc a la mànega d'eslàlom**. Gegant i eslàlom: no acaba |
| | **Marc Oliveras** | **Combinada 2:58.54 — 31è** · **súper-G 1:22.02 — 35è** · **gegant 2:53.74 — 38è** · descens **2:12.76 — 40è** |
| | **Kevin Esteve** | **Descens 2:10.80 — 32è** |
...
**1. El biatló existeix, i té nom.** El corpus tenia registrat: *«Olympedia
llista biatló però no s'ha trobat cap biatleta andorrà.»* **N'hi ha una:
Laure Soulié, Sotxi 2014**, en dues proves. **Buit tancat.**

**2. L'esquí de fons entra el 2006, no el 2010 ni el 2018.** **El corpus ja
havia corregit aquesta dada una vegada** —la taula resum deia 2018 i es va
corregir a 2010 amb Francesc Soulié a Vancouver. **Ara resulta que Soulié ja
hi era a Torí 2006**, en tres proves. **La data bona és 2006.** El corpus deixa
les dues correccions escrites perquè es vegi que **la primera també era
incompleta**.

**3. Sotxi 2014 no va ser només esquí alpí.** La taula resum ho deia. **Van ser
tres esports**: alpí, biatló i surf de neu. **La columna d'esports d'aquella
taula resum s'ha demostrat incompleta dues vegades i queda marcada com a poc
fiable.**

## I un fet del 2014 que no és un resultat

**Andorra va renunciar a places que tenia guanyades.**

> «L'assignació final de quotes del 20 de gener del 2014 donava a Andorra **cinc
> esportistes en posició de classificació** [en esquí alpí]. **L'equip final es
> va anunciar amb quatre, cosa que vol dir que el país va decidir rebutjar una
> de les seves places.**»

I una segona, més sonada:

> «Segons l'assignació de quotes, Andorra tenia un esportista en posició de
> classificació [en esquí de fons]. **Tanmateix, l'equip final no va incloure
> l'esportista classificat, Irineu Esteve Altimiras.**»

**[Irineu Esteve Altimiras](../../persones/irineu-esteve-altimiras.md) s'havia
classificat per a Sotxi 2014 i Andorra no el va portar.** Va debutar **quatre
anys més tard**, a PyeongChang 2018, i **avui és el fondista andorrà amb millor
palmarès de la història**.

**El corpus registra el fet i no n'interpreta el motiu** —la font no en dona
cap— però **el deixa ben visible**, perquè és de les decisions que expliquen
una trajectòria.

## Els noms que apareixen, i quantes vegades
...
| **Nahum Orobitg** | 1988, 1992 |
| **Ramon Rossell** | 1992, 1994 |
| **Alex Antor** | 2002, 2006 |
| **Roger Vidosa** | 2006, 2010 |
| **François / Francesc Soulié** | 2006, 2010 |
| **[Joan Verdú](../../persones/joan-verdu.md)** | 2014, 2018, 2022, 2026 — **quatre** |

**Quatre esportistes andorrans han anat a quatre Jocs d'hivern.** I **tres
d'ells —Escoda, Gómez i Grau— hi van coincidir en tres edicions seguides**:
del 1992 al 1998 la delegació andorrana és, en bona part, **la mateixa gent**.

**Un país que cada quatre anys hi torna amb els mateixos noms** és el que
significa, en la pràctica, tenir setanta-set mil habitants.
...
- [Joan Verdú](../../persones/joan-verdu.md)
- [Irineu Esteve Altimiras](../../persones/irineu-esteve-altimiras.md)
- [L'esquí escolar](../../societat/educacio/lesqui-escolar.md) — d'on surten.

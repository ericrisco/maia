...
- ~~**La Federació Andorrana d'Escacs.**~~ — **`resolt`, i no pas pel seu
  ...
  Escaldes-Engordany el 1948** i **creada oficialment el 7 de novembre del
  1967**, **afiliada a la FIDE des del 1979.** **Detall complet a
  [Josep Oms](./josep-oms.md).**
  **I una absència que val la pena registrar**: **la fitxa de la federació
...
- ~~**Nota `no-es-buit`** — **el que el bolcat sí que dona, i explica per què
  ...
  **Mestre Internacional el 1985 i Gran Mestre el 1989**, **elo màxim 2.545 el
  ...
  del 1991**; **cofundador i conseller delegat d'Oxford Sciences Innovation**,
  un fons de **1.200 milions de lliures** que crea empreses a partir de la
  Universitat d'Oxford, **i fundador d'IP Group plc**; **el 2017 va donar 1,9

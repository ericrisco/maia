---
type: article
title: Pau Klaus Babot i Müller
description: "Migcampista nascut a Frankfurt, de mare andorrana i pare alemany. Juga a la Regionalliga."
...
# Pau Klaus Babot i Müller

## El fet

**Pau Klaus Babot i Müller**, nascut a Frankfurt (Alemanya) el 20 d'agost del 2003.
**Migcampista** ([font](../../../fonts/wikipedia-atletes-andorrans.md)).

| | |
| --- | --- |
| **Naixement** | **Frankfurt (Alemanya), 20 d'agost del 2003** |
| **Posició** | Migcampista |

**FC Bayern Alzenau**, a la **Regionalliga** alemanya.
...
[`Pau_Babot.wiki`](../../../raw/web/esport/atletes/Pau_Babot.wiki).
...
**103 partits de club i 9 gols en total**, en **4 etapes**.

*(Instantània del club del **23 de maig del 2026**.)*

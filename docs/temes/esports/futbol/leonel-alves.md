...
**«Va debutar amb la selecció d'Andorra el 2014.»** **Tota la font és aquesta frase, i està mal formatada** —hi diu «Alvesif» per «Alves». **Errata de la font, registrada.**
...
`raw/web/esport/atletes/Leonel_Alves_(footballer,_born_1993).wiki`.

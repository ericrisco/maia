---
type: article
title: João Pedro da Silva Teixeira
description: "Migcampista nascut a Portugal. Va debutar amb Andorra contra Sud-àfrica el 2024."
...
**João Pedro da Silva Teixeira**, nascut a Chaves (Portugal) el 17 de juliol del 1996.
**Migcampista** ([font](../../../fonts/wikipedia-atletes-andorrans.md)).

| | |
| --- | --- |
| **Naixement** | **Chaves (Portugal), 17 de juliol del 1996** |
| **Posició** | Migcampista |

**Vilar de Perdizes**, a Portugal.

## El que en destaca

**Debut: 21 de març del 2024, amistós contra Sud-àfrica** — **el mateix partit que [Dacu](./dacu.md)**. **És l'únic futbolista de la branca que juga a Portugal mentre és internacional per Andorra**, i **connecta directament amb la segona comunitat estrangera del país**: **9.175 portuguesos** ([la composició per nacionalitats](../../societat/demografia/la-composicio-per-nacionalitats.md)).
...
`raw/web/esport/atletes/João_Teixeira_(footballer,_born_July_1996).wiki`.
...
*(Instantània del club del **21 de desembre del 2025**.)*
...
- ~~**Com es vincula a Andorra** i quants partits ha jugat.~~ — **`resolt`**: **19 partits** amb l'absoluta i **0** gols, segons la taula de dalt.

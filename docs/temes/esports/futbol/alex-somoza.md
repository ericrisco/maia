---
type: article
title: Alexandre «Álex» Somoza i Losada
description: "Migcampista amb nou internacionalitats, avui entrenador de l'Inter d'Escaldes."
...
# Alexandre «Álex» Somoza i Losada

## El fet

**Alexandre «Álex» Somoza i Losada**, nascut  el 7 de juliol del 1986.
...
**FC Santa Coloma**, **CE Principat**, **FC Rànger's**, **CD Binéfar** i **FC Andorra**.

## El que en destaca

**«Avui és entrenador de l'Inter Club d'Escaldes.»** **És el quart exfutbolista andorrà que el corpus troba dirigint**, amb [Koldo Álvarez](./koldo-alvarez.md), [Óscar Sonejee](./oscar-sonejee.md) i [Jesús Lucendo](./jesus-lucendo.md).
...
[`Álex_Somoza.wiki`](../../../raw/web/esport/atletes/Álex_Somoza.wiki).
...
*(Instantània del club del **16:09, 21 August 2017 (UTC)**.)*

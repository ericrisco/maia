---
type: article
title: Manuel «Manolo» Jiménez i Soria
description: "Setanta-nou internacionalitats entre el 1998 i el 2012, catorze anys de selecció."
tema: temes/esports/futbol
veu: compilada
epoca: contemporania
apte_llengua: false
font: wikipedia-atletes-andorrans
timestamp: 2026-09-13T13:44:00Z
tags: [esports, futbol, seleccio]
---

# Manuel «Manolo» Jiménez i Soria

## El fet

**Manuel «Manolo» Jiménez Soria**. **Migcampista**
([font](../../../fonts/wikipedia-atletes-andorrans.md)).

| | |
| --- | --- |
| **Naixement** | **Andorra, 12 d'agost del 1976** |
| **Internacional** | **1998-2012** |
| **Partits** | **79** |
| **Gols** | **1** |

**Juga al Santa Coloma.**

## Catorze anys

**És el desè futbolista amb més partits de la història d'Andorra**
([la selecció](./la-seleccio.md)), **i el corpus no en sap gairebé res més**:
l'entrada de la font és **una sola frase**.

**Setanta-nou partits internacionals documentats i cap altra dada.** El corpus
li fa fitxa igualment, pel criteri de la branca: **la participació documentada
és el criteri, no el resultat.**
...
`raw/raw/web/esport/atletes/Manolo_Jiménez_(footballer,_born_1976).wiki`.

| Anys | Club | Partits | Gols |
| --- | --- | ---: | ---: |
| — | **Santa Coloma** | — | — |

*(Instantània del club del **21 de febrer del 2008**.)*
...
*(Instantània de la selecció del **28 de setembre del 2014**.)*

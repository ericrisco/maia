...
type: article
title: David Buxó
description: "Migcampista amb tres internacionalitats."
...
**David Buxó**, nascut a Andorra el 16 de juny del 1981.
**Migcampista** ([font](../../../fonts/wikipedia-atletes-andorrans.md)).

| | |
| --- | --- |
| **Naixement** | **Andorra, 16 de juny del 1981** |
...
**Tres partits.** **Buxó és un cognom de casa andorrana**, i el corpus el registra com a tal —com fa amb **Naudi**, **Rossell**, **Moles** i **Duedra**.
...
[`David_Buxo.wiki`](../../../raw/web/esport/atletes/David_Buxo.wiki).

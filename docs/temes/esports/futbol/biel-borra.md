---
type: article
title: Biel Borra i Font
description: "Lateral dret format al Girona. Pare andorrà, mare de Banyoles."
...
**Biel Borra i Font**, nascut a Barcelona (Espanya) el 22 d'octubre del 2005.
**Lateral dret** ([font](../../../fonts/wikipedia-atletes-andorrans.md)).

| | |
| --- | --- |
| **Naixement** | **Barcelona (Espanya), 22 d'octubre del 2005** |
| **Partits amb Andorra** | **5** |
| **Posició** | Lateral dret |

**UE Olot**, a Segona Federació. Abans, **planter del Girona FC** des dels dotze anys.
...
- ~~**Els seus cinc partits.**~~ **[parcial · 2026-09-19]** El resum de la
  fitxa dona **5 partits amb l'absoluta**, però la taula en mostra **14** (a
  més de 5 amb l'U19 i 11 amb l'U21). La divergència queda registrada i no
  arbitrada; falten els rivals i les dates.

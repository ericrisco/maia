---
type: article
title: Sebastián Gómez i Pérez
description: "Migcampista amb trenta-dues internacionalitats. Uruguaià nascut a Espanya mentre el seu pare hi jugava a futbol."
tema: temes/esports/futbol
veu: compilada
epoca: contemporania
apte_llengua: false
font: wikipedia-atletes-andorrans
timestamp: 2026-09-13T14:14:00Z
tags: [esports, futbol, seleccio]
---

# Sebastián Gómez i Pérez

## El fet

**Sebastián Gómez Pérez**, **1,76 m**. **Migcampista**
([font](../../../fonts/wikipedia-atletes-andorrans.md)).

| | |
| --- | --- |
| **Naixement** | **Espanya, *(la font no en dona la data)*** |
| **Internacional** | **2008-2019** |
| **Partits** | **32** |
| **Gols** | **0** |

*(el corpus no en té els clubs)*

## Tres països en una frase

> «**Un ciutadà uruguaià nascut a Espanya mentre el seu pare hi jugava a
> futbol**…»

**Uruguaià de nacionalitat, nascut a Espanya, internacional per Andorra.**

**És el cas més complex de tota la branca**, i **el corpus el reté sencer**
perquè **completa el mapa que va dibuixant fitxa a fitxa**: la selecció
andorrana té **gent nascuda a Espanya, a Andorra, amb passaport uruguaià, amb
mare belga, amb mare russa i amb família hindú** ([la
selecció](./la-seleccio.md)).

**I una cosa més:** **el seu pare també era futbolista professional.** **És el

...
type: article
title: Laura Borja
description: "Defensa amb tres internacionalitats."
...
**Laura Borja**, nascuda el **6 de febrer del 2002**.
**Defensa**
([font](../../../../fonts/wikipedia-futbol-femeni-andorra.md)).

| | |
| --- | --- |
| **Naixement** | 6 de febrer del 2002 |
| **Partits amb Andorra** | **3** |
| **Club** | **CD Fontsanta-Fatjó C**, a **Catalunya** |

## El que en destaca

**Darrera convocatòria: contra Malta, el 25 de febrer del 2025.** **Malta és el rival més repetit de la història de la selecció femenina** —**set partits, cap victòria, un empat i 3 gols a favor per 21 en contra** ([la selecció femenina](./la-seleccio-femenina.md)).

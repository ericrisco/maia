---
type: article
title: Nahuel Carabaña
description: "Setè a la final europea dels 3.000 obstacles el 2024. I, dos anys abans, va parar per ajudar un rival lesionat, va acabar últim i el públic el va aplaudir dret."
tema: temes/persones
veu: compilada
epoca: contemporania
apte_llengua: false
...
> provisionals**. **S'han de substituir per les de World Athletics i el COA.**

## Qui és

| Dada | Valor |
| --- | --- |
| **Neix** | **10 de novembre de 1999**, **Andorra la Vella** |
| **Família** | **Pare espanyol, mare argentina** |
| **Prova** | **3.000 metres obstacles** |
| **Rècords andorrans** | **3.000 m**, **5.000 m**, **10.000 m** i **3.000 m obstacles** |
| **Millor marca** | **8:16.04** — Marsella, **2024** |

**Quatre rècords nacionals alhora.** En un país de 80.000 habitants, **un sol
atleta pot ser el millor de la història en tota una família de proves**.

## Els resultats

| Competició | Resultat | Any |
| --- | --- | --- |
| **Campionat d'Europa sub-23** | **BRONZE** — **primera medalla andorrana en aquest nivell** | **2021** |
| **Jocs dels Petits Estats** | **Campió**, 3.000 obstacles | **2023** |
| **Campionat d'Europa absolut** | **7è a la final**, **8:21.08** | **2024** |
| **Campionat d'Europa** | Sèries, 9:37.74, no passa | **2022** |
| **Jocs Olímpics de París** | Sèrie, **8:19.44**, 7è, no passa | **2024** |

**El setè lloc de la final europea del 2024 és el millor resultat andorrà en
atletisme que aquesta font documenta.**
...
A les sèries dels 3.000 obstacles del **Campionat d'Europa de Munic**, el danès
**Axel Vang Christensen** es va lesionar enmig de la cursa.

> **Carabaña «es va girar per ajudar Vang Christensen a sortir de la pista;
> Carabaña va acabar la cursa en darrer lloc i va rebre una ovació dempeus».**
...
com competeix un país petit**: el Comitè Olímpic Andorrà porta als Jocs dels
Petits Estats **esportistes «que no havien assolit la marca però que hi estaven a
prop»**, perquè **omplir la delegació és part de l'objectiu**
([els Jocs dels Petits Estats](../esports/competicio/els-jocs-dels-petits-estats.md)).

**Ser-hi compta.** **Això no és una tesi de la font: és una observació del
corpus, i queda marcada com a tal.**

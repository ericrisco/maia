---
type: article
title: Les vagues de FHASA
description: "Quatre vagues revolucionàries entre 1931 i 1933, fetes sobretot per obrers espanyols de la CNT. Les úniques vagues generals que ha tingut Andorra."
...
tags: [historia, segle-xx, treball, drets, immigracio]
---
...
**Les condicions laborals, especialment els salaris.**

I hi havia una raó estructural: **un sector públic poc desenvolupat i un cert
grau de passivitat de les autoritats locals permetien que
[FHASA](../../economia/energia-i-serveis/fhasa.md) actués en les relacions
laborals sense cap arbitratge.**
...
afiliats a la Confederació Nacional del Treball (CNT)**. **Els sindicats
espanyols no van ser aliens als conflictes.**

Això s'ha de dir amb precisió i sense estirar-ho: **les vagues que van sacsejar
Andorra el 1931 i el 1933 les van fer, en bona part, treballadors immigrants
anarcosindicalistes**.

**I no van ser violentes en cap moment.** L'autora ho subratlla, i afegeix que
**van causar un fort impacte en la població andorrana** i que **els fets van
perdurar en la memòria dels qui hi van assistir**.

## La correcció que això fa al corpus

**Aquesta fitxa corregeix la de [la Revolució de 1933](./la-revolucio-de-1933.md).**

Aquella fitxa explicava el 1933 com **un episodi polític andorrà**: uns joves
ocupen la Casa de la Vall, el Consell aprova el sufragi universal masculí, el
Tribunal de Corts destitueix el Consell, arriben els gendarmes.

**Faltava la meitat de la història, i és la meitat obrera.**

Lluelles ho posa en una sola frase:

> **«Les protestes laborals coincideixen amb la destitució del Consell General
> per sentència del Tribunal de Corts i amb les reivindicacions dels joves
> andorrans, que reclamen el dret al sufragi universal masculí. Amb motiu dels
> conflictes laborals i les tensions polítiques internes, els coprínceps acorden
> fer entrar la Gendarmeria francesa per pacificar el país.»**

És a dir:

1. **Hi ha dos moviments alhora**, no un: **la vaga obrera** i **la reivindicació
   política dels joves andorrans**.
2. **Els gendarmes no entren només per la crisi institucional**: entren **per
   «els conflictes laborals I les tensions polítiques internes»**.
3. **Qui manava els gendarmes** —**René Baulard**— **és la mateixa font que
   compta els obrers de FHASA**. El cap de la força d'ocupació va deixar el
   cens de la plantilla.

**La Revolució de 1933 és, alhora, una vaga.** I algunes fonts populars li diuen
...
**Distingir-ho és exactament la feina.** **Buit registrat, prioritari:** la
relació real entre les dues coses.

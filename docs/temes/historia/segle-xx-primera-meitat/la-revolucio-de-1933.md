...
de vot**. I la resposta dels dos caps d'estat va ser **enviar policia estrangera
a ocupar el país durant set setmanes**, fins que es va elegir un Consell que els
convenia més.

Les dues coses van passar el mateix any i formen part del mateix episodi.

## La connexió que explica el que ve després

Aquest és el context immediat de
[Boris Skossyreff](./boris-skossyreff.md), que el **juliol de 1934** —menys d'un
any després— va ser votat rei pel Consell General per **24 vots a 1**.

Aquella votació, llegida en sec, sembla inexplicable. Llegida darrere del 1933,
no ho és tant: un Consell que acabava de ser destituït, ocupat per gendarmes
estrangers i reconstituït sota pressió dels coprínceps, escolta un home que li
proposa **una constitució nova amb llibertat política, religiosa i de premsa**.

No es diu aquí que això justifiqui el vot ni que l'expliqui del tot. Es diu que
**els dos episodis no es poden llegir per separat**, i que fins ara en aquest
corpus s'havien llegit així.

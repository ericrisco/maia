...
description: Un país sense exèrcit entre dos estats en guerra, i els passadors que hi van portar gent.
...
Andorra va travessar el segle XX sense exèrcit i entre dos estats que s'hi van
jugar molt: l'Espanya de la guerra civil al sud i la França ocupada al nord.

## Els passadors

Durant la **Segona Guerra Mundial**, el pas de refugiats per Andorra va ser
constant, i moltes famílies s'hi van oferir com a **passadors** a canvi de
diners ([Viquipèdia](../../../fonts/viquipedia-ca.md)). Les mateixes rutes i el

---
type: article
title: La deriva presidencialista
description: "Un ex-síndic general compta les iniciatives del Consell i conclou que el règim s'està transformant: «cada dia que passa el règim es va transformant… amb un règim de Coprincipat presidencialista»."
...
tags: [politica, parlamentarisme, constitucio-1993, partits, debat-obert, tesi-de-part]
---

# La deriva presidencialista

## Qui ho diu importa

Ho diu **Josep Dallerès i Codina**, que ha estat **síndic general** —és a dir,
ha presidit el Consell General— i també ministre i ambaixador
([font](../../../fonts/dalleres-coprincipat-parlamentari.md)).

**El títol de la seva ponència és una pregunta:** *Coprincipat parlamentari?*

## El que diu la llei

L'article **1.4** de la Constitució: **«El règim polític d'Andorra és el
Coprincipat parlamentari.»** L'article **1.3**: **«La sobirania resideix en el
poble andorrà.»** L'article **50**:

> «El **Consell General**, que expressa la representació mixta i paritària de la
> població nacional i de les set parròquies, **representa el poble andorrà**,
> **exerceix la potestat legislativa**, **aprova els pressupostos de l'Estat** i
> **impulsa** i **controla l'acció política del Govern**.»

**Quatre funcions.** La pregunta de Dallerès és si les exerceix.

## El mètode, que és el que salva la fitxa

**No opina primer: compta.** Agafa el **Butlletí del Consell General** i mesura
l'activitat de **dos trams de tres anys separats per vint anys**: **1994-1996**
—els tres primers postconstitucionals— i **2015-2017**.

**Avís del corpus:** les taules d'aquesta ponència **surten amb les columnes
barrejades** en l'extracció de text del PDF i **no es transcriuen**. El que
segueix són **els percentatges i els fets que l'autor escriu en prosa**, que sí
que són fiables.
...
**El corpus reté aquesta honestedat com a mètode.** És exactament el que fa
falta quan una xifra admet quatre lectures.

## La tesi

Aquí sí que es mulla, i el corpus **ho marca com a tesi d'un actor polític**:
...
> Constitucional** o **per la manera de fer dels partits polítics**, amb un
> **règim de Coprincipat presidencialista**, amb tot el risc que tal evolució
> comporta.»

### El mecanisme que proposa
...
1. El sistema del 1993 substitueix **el recompte uninominal** per **l'ordre a la
   llista tancada**.
2. Qui decideix aquest ordre **és qui domina l'aparell del partit**.
3. La llista la **encapçala el candidat a cap de Govern** —tot i que, remarca
   Dallerès, **cap text legal no obliga que sigui així**, i el càrrec **el pot
   ocupar algú no elegit**.
4. Conseqüència: dins el Consell **«esdevingui difícil no donar suport a les
   polítiques proposades pel Govern fins i tot quan no corresponen a les
   defensades durant la campanya electoral»**.

**El diputat deu l'escó a qui ha de controlar.**

Hi suma dos elements més: **la Llei del sòl**, que en alguns punts «dona
preponderància a la decisió del Govern sobre els comuns», i **una sentència del
Tribunal Constitucional sobre la utilització de béns comunals**. **El corpus no
té cap de les dues** — buits registrats.

## La frase sobre els partits

És la més dura, i és d'algú que ha governat:

> «**La raó de ser dels partits, a la base, no deixa de ser poder estructurar-se
> per arribar a poder fer front a l'oligarquisme. Què passa, però, quan el mateix
> partit es comporta com a oligarca?**»

**Això connecta amb l'origen.** Vela demostra que **el 1419 el Consell de la
Terra neix com a instrument d'un grup de notables**
([el parlamentarisme andorrà](./el-parlamentarisme-andorra.md)). Dallerès, sis
segles després, es pregunta si el remei ha heretat la malaltia. **El corpus
...
I hi posa exemples **de fora**: les propostes de **Roosevelt entre 1935 i 1937**,
que **van fracassar gràcies als contrapoders**; i, al contrari, **Hitler a
Alemanya** i **Perón a l'Argentina**, on «les institucions havien estat
infiltrades o sotmeses al poder presidencial».
...
- [Els tres sistemes electorals](../sistema-electoral/els-tres-sistemes-electorals.md) — el mecanisme, en detall.
- [L'abstenció](../sistema-electoral/labstencio.md) — l'altra meitat del diagnòstic.

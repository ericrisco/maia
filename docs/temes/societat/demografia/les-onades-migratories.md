---
type: article
title: Les onades migratòries
description: "De 4.039 habitants el 1932 a 8.792 el 1960: el país es duplica en vint-i-vuit anys. Amb les xifres d'arribades trienni a trienni."
...
tags: [demografia, immigracio, segle-xx, xifres, fhasa, transformacio-economica]
---
...
> «**En vint-i-vuit anys, de l'any 32 als anys 60, la població pràcticament es
> dobla**: passa de **4.039 a 8.792 habitants**. L'any 1960, **el trencament ja
> està consumit**. S'acaba l'època de transició.»
>
> — Martina Camiade ([font](../../../fonts/camiade-migracions.md))

## Població per parròquia

| Any | Canillo | Encamp | Ordino | La Massana | Andorra | Sant Julià | **Total** |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| **1932** | 767 | 424 | 454 | 613 | 1.034 | 747 | **4.039** |
| **1944** | 702 | 640 | 550 | 649 | 1.980 | 770 | **5.291** |
| **1950** | 600 | 650 | 490 | 620 | 2.866 | 950 | **6.176** |
| **1955** | 448 | 630 | 431 | 516 | 3.142 | 1.012 | **6.179** |
| **1960** | 404 | 806 | 532 | 581 | 4.777 | 1.392 | **8.792** |
...
| Parròquia | 1932 | 1955 | Variació |
| --- | ---: | ---: | --- |
| **Canillo** | 767 | **448** | **−42%** |
| **Ordino** | 454 | **431** | **−5%** |
| **La Massana** | 613 | **516** | **−16%** |
| **Andorra la Vella** | 1.034 | **3.142** | **+204%** |

**Canillo perd quatre de cada deu habitants entre 1932 i 1955** — **en el mateix
període en què el país creix un 53%**.

**Això no és immigració: és despoblament rural interior simultani a la
immigració exterior.** La gent no només arribava de fora: **baixava de les
parròquies altes cap a Andorra la Vella**.

Aquesta és **una de les dades més importants que el corpus ha incorporat sobre
demografia**, perquè explica de cop diverses coses que tenia soltes:

- Per què **Canillo és la parròquia més rica en béns comunals**
  ([quarts i veïnats](../../institucions/quarts-i-veinats/quarts-i-veinats.md))
  **i alhora de les menys poblades**.
- Per què les **bordes** deixen de ser agrícoles i acaben sent restaurants
  ([l'agricultura de subsistència](../../economia/ramaderia-i-agricultura/lagricultura-de-subsistencia.md)).
- Per què **el ferrer desapareix** per falta de clients
  ([el ferro](../../cultura/artesania/el-ferro.md)).
- Per què les **danses i festes** es concentren en poques parròquies
  ([danses](../../costums/danses/danses.md)).

**El país no es va omplir: es va buidar per dalt i es va omplir per baix.**

A partir de **1955** el moviment s'inverteix i **totes les parròquies creixen**,
també Encamp i Ordino. **El punt d'inflexió és a mitjan anys cinquanta.**

## Les arribades, trienni a trienni

Camiade dona la sèrie en nota, i precisa: «**l'onada més gran que envaeix Andorra
es produeix a la meitat dels anys 50**».
...
**De 1954 a 1972: més de 14.000 arribades** en un país que el 1932 en tenia
**4.039**.

**El màxim és 1967-1969**, no els cinquanta — cosa que **matisa la frase de la
pròpia autora**. El corpus ho deixa dit: **l'onada més notada potser va ser la
dels cinquanta, però la més gran en xifres és la de finals dels seixanta**.

Això quadra amb **el gir de la cuina als anys seixanta**
([el gir dels seixanta](../../gastronomia/historia-alimentaria/el-gir-dels-seixanta.md))
i amb el que Ubach diu que **als cinquanta comencen a arribar francesos i
espanyols**
([el sindicalisme](../treball/el-sindicalisme.md)).

## D'on ve tot això: dues obres públiques

Camiade ho data amb precisió:

> «les **primeres immigracions d'importància** es donen a partir de **la
> construcció de la carretera de la Seu, l'any 1916**, i **de la resta de les
> Valls, clàusula de la concessió atorgada per l'explotació de l'energia
> hidroelèctrica a partir de l'any 1929**.»

| Any | Obra |
| --- | --- |
| **1916** | **Carretera de la Seu** |
| **1929** | **La resta de carreteres**, **com a clàusula de la concessió hidroelèctrica** |

**Les carreteres d'Andorra les va pagar la concessió de l'aigua.**

Això **completa** el que el corpus ja sabia
([el Banc Agrícol](../../economia/banca-i-fiscalitat/el-banc-agricol.md)): la
concessió de 1928-1930 a Boussac i Gómez Quintero **no era només aigua i banca —
també portava carreteres**.

**Tres coses en un sol paquet: electricitat, banca i carreteres.** I el que va
arribar amb elles va ser **gent**.

### I la conseqüència immediata

> «L'allau d'obrers —**un miler** per a la construcció de les carreteres— **va
...
primera onada és de 1931 i és de carreteres, no de central**.
...
- [La població al segle XIX](./la-poblacio-al-segle-xix.md) — el que hi havia abans.
- [Les comunitats](../immigracio/les-comunitats.md) — qui va arribar.
- [El Banc Agrícol](../../economia/banca-i-fiscalitat/el-banc-agricol.md) — la concessió sencera.

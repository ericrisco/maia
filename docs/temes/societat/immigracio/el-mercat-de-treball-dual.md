---
type: article
title: El mercat de treball dual
description: "Un segment primari d'andorrans i residents antics amb feina estable, i un segment secundari d'immigrats que sosté l'economia productiva. «La principal defensa del treballador ha estat canviar de feina.»"
tema: temes/societat/immigracio
veu: compilada
epoca: contemporania
apte_llengua: false
font: mico-interculturalitat
timestamp: 2026-09-13T17:10:00Z
tags: [immigracio, treball, societat, desigualtat, nacionalitat, xarxes-migratories]
---

# El mercat de treball dual

## Les tres línies que parteixen el país

Segons el director del **CRES**
([font](../../../fonts/mico-interculturalitat.md)), seguint *Andorra, un país de
frontera* de **Comas d'Argemir i Pujadas (1997)**, la societat andorrana està
travessada per **tres segmentacions que s'interrelacionen**:

| Segmentació | De què va |
| --- | --- |
| **Econòmica i ocupacional** | **Qui treballa de què**, segons l'origen |
| **Política** | **Qui vota** |
| **Social (o de prestigi cultural)** | **Qui val més** a ulls de qui |

Aquesta fitxa és de la primera. La segona és a
[la desigualtat del vot](../../politica/sistema-electoral/la-desigualtat-del-vot.md);
la tercera, a [la piràmide de prestigi](./la-piramide-de-prestigi.md).

## Els dos segments

| | **Segment primari** | **Segment secundari** |
| --- | --- | --- |
| **Qui** | **Andorrans**, residents de molts anys, gent amb molta formació | **Molta de la població immigrada** |
| **Sectors** | Administracions i parapúbliques, **financer, immobiliari, assegurances, professions liberals**, càrrecs directius | **Comerç, hoteleria i restauració** |
| **Condicions** | Feina estable, **de dilluns a divendres**, bons horaris, bones condicions econòmiques | Precarietat, menys estabilitat, **salaris més baixos**, menys promoció |
| **Horaris** | — | **Llargues jornades en caps de setmana i festius** |
| **Sindicats** | **Sí, però només a les empreses públiques i parapúbliques** | **No funcionen els mecanismes de defensa** |

**I la frase que defineix com es defensa qui és a baix:**

> «**la principal defensa del treballador ha estat tradicionalment**, i en un
> context de gran creixement econòmic, **canviar de feina** a una amb millors
> condicions.»

**No negociar: marxar.** Això lliga exactament amb el que el corpus ja tenia a
[l'acomiadament lliure](../treball/lacomiadament-lliure.md) i a
[el sindicalisme](../treball/el-sindicalisme.md) —sindicats només al sector
públic— i **ara té l'explicació estructural**.

### La paradoxa, dita per la font

> «Es dona la paradoxa que **la major part de l'economia productiva del país es
> basa en la feina d'aquests treballadors**, i que a més, **la major part dels
> serveis públics no s'adapten prou bé a les necessitats** dels treballadors del
> segment secundari.»

I hi afegeix, **entre parèntesis i com a pregunta**, la connexió que el corpus
subratlla:

> «(**deu ser perquè la majoria no té dret al vot** i per tant, en el mercat
> polític **els seus interessos estan en un segon o tercer terme**?)»

**Qui fa funcionar l'economia no vota, i els serveis públics no el tenen en
compte.** La font ho planteja com a pregunta; **el corpus la reté com a
pregunta**, no com a conclusió.

## Per què el mercat es va partir així

**Quatre causes, i cap és casual.**

### 1. El creixement va necessitar mà d'obra en tres sectors

**Construcció i annexos, comerç i hoteleria.** «La major part dels immigrants es
van ocupar en aquests sectors.»

### 2. Les xarxes migratòries

**La gent va venir on ja tenia algú.** I això ha deixat **pobles sencers
representats a Andorra**:

| Poble | D'on |
| --- | --- |
| **Mojácar** | Almeria |
| **Lalín** | Pontevedra |
| **Viana do Castelo** | Nord de Portugal |

> «**El boca a orella ha estat un factor molt important.**»

**Tres topònims que el corpus no tenia i que valen molt**: són **els llocs
concrets d'on ve la població d'Andorra**. Material per a
[l'experiència de migrar](./lexperiencia-de-migrar.md).

### 3. Les limitacions legals d'accés a la feina

**Aquesta és la causa més dura i la més documentable.**
...
**Conseqüència que la font formula com a fet:**

> «les administracions públiques i parapúbliques estiguin **ocupades
> majoritàriament per andorrans**, a més de **la major part de les professions
> liberals**.»

I del costat contrari:

> «al sector de **la neteja a la llar o de cuidadors personals** hi hagi un
> volum important de persones procedents de **Filipines o Sud-amèrica**. Així
> mateix, **la major part del treball temporal especialitzat d'hivern prové de
> l'Argentina i Xile**.»

**La composició de cada ofici a Andorra és el residu d'una llei de permisos.**

**I el detall dels prestanoms**, que la font dona com a cosa sabuda:

> «aquesta limitació **no ha estat realment un impediment** perquè persones no
> andorranes poguessin obrir un negoci, ja que, **com ja sabeu, era molt normal
> utilitzar la figura del prestanoms**.»

**El corpus ho registra com a pràctica descrita per una font institucional**, no
com a acusació: la Llei del 100% andorrà **es complia sobre el paper**.

### 4. Els idiomes

**Per a les feines amb millors condicions cal el català**, i també **el castellà
i el francès**, i **cada cop més l'anglès**.

> «Imagineu **l'esforç que ha de fer una persona provinent per exemple de
> Portugal** per poder accedir a la major part de les feines administratives del
> país.»

**Quatre llengües com a requisit efectiu en un país de 78.000 habitants.** Això
és, alhora, la barrera d'entrada i —com mostra
[el català com a ascensor social](../../llengua/politica-linguistica/qui-parla-que.md)—
la via de sortida.

### I la convalidació d'estudis

**Els extracomunitaris** tenen **els mateixos problemes que a la resta
d'Europa** per convalidar títols. «Aquesta circumstància ha limitat la
possibilitat d'obtenir feines qualificades per a persones extracomunitàries **i
amb estudis superiors**.»

**Gent amb carrera treballant per sota de la seva formació**, per un tràmit.

## Què hi ha en positiu, segons la font

**El corpus ho separa perquè és valoració, i perquè l'autor la sosté amb un
estudi propi:**

- **El percentatge i el nombre absolut de feines amb bones condicions ha
  augmentat** en trenta-cinc anys.
- **Molta gent ha passat del segment secundari al primari.**
- **Els nascuts al país entren bé al mercat de treball**, fills d'andorrans i
  fills de no andorrans. El CRES ho va mesurar seguint **els qui van acabar
  l'escolarització obligatòria el 2004** i van entrar a treballar **en plena
  crisi**: «els resultats… eren molt satisfactoris».

> «La bona entrada al mercat laboral de les persones escolaritzades al país ha
> estat, **al nostre entendre, un factor de cohesió molt important**.»

- I una percepció que el corpus no tenia: **la majoria dels andorrans no veu els
  immigrants com un risc per a la seva feina**, i **aquesta percepció es va
  mantenir durant la crisi**.

**El que no diu la font, i el corpus assenyala:** la mobilitat cap al segment
primari **també s'explica perquè qui no se'n sortia marxava** — i entre el 2008 i
el 2012 **el país va perdre població**
...
- [La piràmide de prestigi](./la-piramide-de-prestigi.md) — l'altra segmentació.
- [La societat segmentada](./la-societat-segmentada.md) — la versió del 1993-95.
- [La composició per nacionalitats](../demografia/la-composicio-per-nacionalitats.md)
- [El sindicalisme](../treball/el-sindicalisme.md) — per què només al sector públic.

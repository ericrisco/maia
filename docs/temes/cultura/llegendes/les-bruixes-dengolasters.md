...
- ~~**Nota `no-es-buit`:** el *Costumari català* **no s'ha consultat directament**;
  ...
  la font disponible, no una pregunta amb resposta pendent dins del corpus.~~ — **`no-es-buit` el 2026-09-22**: és una limitació del registre, no una pregunta de contingut.

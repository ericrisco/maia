...
abast: >
  Tractat de dret públic i internacional sobre Andorra, en tres parts:
  història (abans dels pariatges, els pariatges, després), règim polític i
  administratiu amb la sobirania dels cosenyors, i la qüestió de la sobirania,
  la qüestió duanera i la modernització. Amb el desenllaç documentat de l'afer
  duaner de 1895 i cites de premsa espanyola del 27 de juny de 1895. A
  docs/raw/llibres/vilar-andorre-1904.txt. Al mateix directori hi ha una segona
  obra del mateix autor, «Un État ignoré: l'Andorre», signada com a conseller
  general dels Pirineus Orientals.
notes: >
  ES LA TESI FRANCESA, I NO LA DISSIMULA. Vilar dona la qüestió de la sobirania
  per «historiquement et légalement résolue» a favor de França: cita el decret
  del 27 de març de 1806 i la Cort de Cassació —affaire Laugé, 9 de maig de
  1845, Dalloz 1845, I, 223— que fa d'Andorra «une prolongation du territoire
  français». Es el mirall exacte de la tesi espanyola de Carvajal. El corpus
  reté els documents que cita i marca la tesi com a seva.
  I ES PART INTERESSADA EN LA QÜESTIÓ DUANERA QUE DESCRIU. Era CONSELLER
  GENERAL DELS PIRINEUS ORIENTALS i va fer adoptar al seu consell general, el 5
  d'octubre de 1904, un vot demanant un nou cens dels ramats andorrans «dans des
  conditions de stricte sincérité», una verificació severa dels certificats
  d'origen per la duana francesa, i limitar l'entrada en franquícia a certes
  èpoques. Escriu sobre les franquícies andorranes MENTRE FA CAMPANYA PER
  RESTRINGIR-LES.
  PERÒ APORTA EL QUE NINGÚ MÉS TÉ: el text de la quota de Carvajal, la data de
  l'aprovació al Congrés, la data de la comissió mixta, el desenllaç al Senat i
  DUES CITES DE PREMSA ESPANYOLA del 27 de juny de 1895 traduïdes al francès
  —La Correspondencia de España i el Heraldo de Madrid—, els dos diaris dels
...
> **André Vilar, docteur en droit, *L'Andorre*.** París, **V. Giard & E. Brière**,
> 16 rue Soufflot. **1904.**

El mateix any que
[*La Coutume d'Andorre* de Brutails](./brutails-coutume-1904.md), i des de
l'angle contrari: **no el costum, sinó el dret públic i internacional**.

## Per què val, i per què s'ha de llegir amb guants

Val perquè **tanca el desenllaç** de l'afer duaner de 1895 que el corpus tenia
obert, i perquè **cita la premsa espanyola que el corpus no pot llegir**.

S'ha de llegir amb guants perquè **l'autor és part**: conseller general dels
Pirineus Orientals, **feia campanya per restringir les franquícies andorranes a
França** mentre escrivia aquest llibre.

I perquè la seva tesi de fons —que França hi té **«un droit de suzeraineté»**— és
**la contrària** de la que sostenia el parlament espanyol el 1895 i de la que
sostenia el mateix Consell General el 1894. Les tres, a
[les tres sobiranies](../temes/institucions/coprincipat/les-tres-sobiranies.md).
...
| **pp. 181-184** | **bibliografia**, trenta-cinc entrades | **destil·lada el 17-09-2026** a [tot venia de la mateixa prestatgeria](../temes/historia/historiografia/tot-venia-de-la-mateixa-prestatgeria.md) |
